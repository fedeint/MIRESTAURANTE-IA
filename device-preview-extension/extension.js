...
function getWebviewContent(context, webview, appUrl) {
  ...
  const modeBuildJsUri = webview.asWebviewUri(vscode.Uri.joinPath(context.extensionUri, 'webview', 'mode-build.js'));
  ...
  html = html.replace(/\{\{MODE_BUILD_JS_URI\}\}/g, modeBuildJsUri.toString());
